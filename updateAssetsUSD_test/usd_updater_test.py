...
class USDParserTest(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        self.assertEqual(layer_widget.label.text(), '<b>USD</b><br> - Cat_USD_v009.usda')
    ...
    def test_update(self):
        ...
        layer_widget_up: UD.usd_updater.LayerWidget = main_window.layerList.itemWidget(item_up)
        self.assertTrue(os.path.exists(layer_path_up))
        self.assertEqual(main_window.layerList.count(), 1)
        self.assertEqual(main_window._layers[0].identifier, layer_path_up)
        self.assertEqual(layer_widget_up.label.text(), '<b>USD</b><br> - Cat_USD_v011.usda')
        self.assertEqual(layer_widget_up.update_label.text(), UD.usd_updater.LayerWidget.UpdateTextEnum.UPDATED.value)
        
        asset_list_up: UD.usd_updater.AssetListWidget = main_window.QTabLayers.widget(0)
        self.assertEqual(
            asset_list_up.layer_type,
            UD.usd_updater.AssetListWidget.LayerType.CONTAINER
        )
    ...
    def test_update_sublayers(self): 
        ...
        dpt_layer_widget: UD.usd_updater.LayerWidget = main_window.layerList.itemWidget(dpt_item)
        dpt_asset_list: UD.usd_updater.AssetListWidget = main_window.QTabLayers.widget(0)

        self.assertEqual(main_window._layers[0].identifier, dpt_layer_path)
        self.assertEqual(dpt_layer_widget.label.text(), '<b>_layer_anm_master</b><br> - Cat__layer_anm_master_v002.usda')
        self.assertEqual(dpt_layer_widget.update_label.text(), UD.usd_updater.LayerWidget.UpdateTextEnum.NOT_UPDATED.value)
        self.assertEqual(
        ...
        ctn_layer_widget: UD.usd_updater.LayerWidget = main_window.layerList.itemWidget(ctn_item)
        ctn_asset_list: UD.usd_updater.AssetListWidget = main_window.QTabLayers.widget(1)

        self.assertEqual(ctn_layer_widget.label.text(), '<b>USD</b><br> - Cat_USD_v010.usda')
        self.assertEqual(ctn_layer_widget.update_label.text(), UD.usd_updater.LayerWidget.UpdateTextEnum.UPDATED.value)
        self.assertEqual(
        ...
        dpt_layer_widget_up: UD.usd_updater.LayerWidget = main_window.layerList.itemWidget(dpt_item_up)
        dpt_asset_list_up: UD.usd_updater.AssetListWidget = main_window.QTabLayers.widget(1)

        self.assertEqual(main_window._layers[1].identifier, dpt_layer_path_up)
        self.assertEqual(dpt_layer_widget_up.label.text(), '<b>_layer_anm_master</b><br> - Cat__layer_anm_master_v004.usda')
        self.assertEqual(dpt_layer_widget_up.update_label.text(), UD.usd_updater.LayerWidget.UpdateTextEnum.UPDATED.value)
        self.assertEqual(
        ...
        ctn_layer_widget_up: UD.usd_updater.LayerWidget = main_window.layerList.itemWidget(ctn_item_up)
        ctn_asset_list_up: UD.usd_updater.AssetListWidget = main_window.QTabLayers.widget(0)

        self.assertEqual(main_window._layers[0].identifier, ctn_layer_path_up)
        self.assertEqual(ctn_layer_widget_up.label.text(), '<b>USD</b><br> - Cat_USD_v011.usda')
        self.assertEqual(ctn_layer_widget_up.update_label.text(), UD.usd_updater.LayerWidget.UpdateTextEnum.UPDATED.value)
        self.assertEqual(
